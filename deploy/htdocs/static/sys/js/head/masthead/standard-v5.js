...
/**
 * Masthead 5.0
 * @version FDev3 5.0 2012.06.29
 * @author Denis
 */
if (!FD.sys.Masthead) {
    FDEV.namespace('FD.sys.Masthead');
    FYE.onDOMReady(function(){
        var masthead = FYG('masthead-v5');
        if (!masthead) {
            return;
        }
        //noformat
        var $D = FYD,
            ...
            searchType = FYS('ul.alisearch-type-v5', masthead, true),
            searchContainer = $D.getNextSibling(searchType),
            searchCategory = FYS('>div.alisearch-category-v5', searchContainer, true),
