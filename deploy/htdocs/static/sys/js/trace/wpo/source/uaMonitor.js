 ...
 * 检查浏览器类型及终端信息
 * @author : yu.yuy
 * @createTime : 2010-12-27
 */

var uaMonitor = function(){
    var engine = {
        trident : 0,
        webkit : 0,
        gecko : 0,
    ...
    if (window.opera){
        engine.ver = browser.ver = numberify(window.opera.version());
    ...
    // Maxthon
    else if ((match = ua.match(/Maxthon/)) && (external = window.external)) {
