...
*		
*       在页面最底部
*       <script>new FE.sys.Hubble(window.g_config)</script>
*
...
(function($,SYS){
	...
	// 考虑到哈勃监控系统页面布点是基于KISSY的框架写的,jQuery所提供数据还还无法满足本次的要求,所以独自封装了UA的数据,代码来源于KISSY
	UA = (function(){
