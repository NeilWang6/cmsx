...
(function(win,S){
	...
	/**
	 * offerdetail-出错页-供应商的其他相关信息-猜你喜欢
	 ...
	 */
	S.DetailErrorGuess = function(callback,data,oFlyConfig,oMergedFlyConfig){
		//实例化父类
		S.DetailErrorGuess.superclass.constructor.call(this, data,oFlyConfig,oMergedFlyConfig);
		this.result = data;
	...
	//继承父类
	L.extend(S.DetailErrorGuess,S.AbstractFlyView);
	//接口实例化
	L.augment(S.DetailErrorGuess,S.InterfaceFlyView);
	
	//方法封装
	L.augmentObject(S.DetailErrorGuess.prototype,{
		onSuccess:function(){
			FD.sys.fly.Utils.log('DetailErrorGuess');
			this._render();
		},
		onFailure:function(){
			this._failRender();
