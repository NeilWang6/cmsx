...
http://style.c.aliimg.com/js/sys/fly/widget/favorites-status-supply.offer-focus.js
http://style.c.aliimg.com/js/sys/fly/widget/favorites-status-supply.offer-top.js
http://style.c.aliimg.com/js/sys/fly/widget/favorites-status-supply.similar-hot.js
*/
...
var L = YAHOO.lang,D = YAHOO.util.Dom, E = YAHOO.util.Event;
/**
* 阿里助手-供应收藏状态-同类公司最热收藏
* @param {String} callback 		返回的状态 onSuccess|onFailure|onTimeout|onProgress
* @param {Object} data 			返回的数据
* @param {Object} oFlyConfig 		初始化的配置参数
* @param {Object} oMergedFlyConfig	经过mergeed后的配置参数,它跟oFlyConfig不同在于,这个参数就是真正向接口发起请求的所带的参数
*/
S.FavoritesStatusSupplySimilar = function(callback,data,oFlyConfig,oMergedFlyConfig){
//实例化父类
S.FavoritesStatusSupplySimilar.superclass.constructor.call(this, data,oFlyConfig,oMergedFlyConfig);
this.result = data;
this.oFlyConfig = oFlyConfig;
this.oMergedFlyConfig = oMergedFlyConfig;
this[callback]();
...
//继承父类
L.extend(S.FavoritesStatusSupplySimilar,S.AbstractFlyView);
//接口实例化
L.augment(S.FavoritesStatusSupplySimilar,S.InterfaceFlyView);
//方法封装
L.augmentObject(S.FavoritesStatusSupplySimilar.prototype,{
onSuccess:function(){
FD.sys.fly.Utils.log('FavoritesStatusSupplySimilar');
this._render();
new FD.widget.Alitalk(FYS( 'a[alitalk]', 'favorites-supply-similar' ), {
onRemote: function() {
switch(this.opt.online) {
case 0:
case 2:
