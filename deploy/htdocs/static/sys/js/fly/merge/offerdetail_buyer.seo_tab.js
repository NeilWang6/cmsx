...
http://style.c.aliimg.com/js/sys/fly/widget/offerdetail_buyer.seo_tab.js
*/
...
onSuccess:function(){
FD.sys.fly.Utils.log('offerdetail-buyer-seo-tab');
this._render();
},
onFailure:function(){
this._render();
...
var _title = '<p><a href="'+detailUrl+'"  onmousedown="FD.sys.fly.Utils.iClick({\'page\':'+this.oFlyConfig.coaseType+',\'objectId\':\''+offer.offerId+'\',\'recId\':\''+this.oFlyConfig.recid+'\',\'alg\':\''+offer.alg+'\',\'objectType\':\'offer\',\'pid\':\''+this.oFlyConfig.pid+'\'})" target="_blank"><span class="red">'+FD.sys.fly.Utils.doSubstring(offer.subject,16,true)+'</span></a></p>';
return _title;
},
...
var _biginfo = '<div class="dt-img-wrap"><a href="'+detailUrl+'" target="_blank" onmousedown="FD.sys.fly.Utils.iClick({\'page\':'+this.oFlyConfig.coaseType+',\'objectId\':\''+offer.offerId+'\',\'recId\':\''+this.oFlyConfig.recid+'\',\'alg\':\''+offer.alg+'\',\'objectType\':\'offer\',\'pid\':\''+this.oFlyConfig.pid+'\'})"><img class="dt-gallery-img" width="48px" height="48px" alt="" src="'+FD.sys.fly.Utils.getOfferImageURL(offer.offerImageUrl,0)+'"  onerror="javascript:this.src=\'http://img.china.alibaba.com/news/upload/5002027/48x48_1276134613200.gif\'"/></a>';
