...
http://style.c.aliimg.com/js/sys/fly/widget/myalibaba-favorites.guess-you-link.js
*/
...
*/
S.MyalibabaFavoritesGuess = function(callback,data,oFlyConfig,oMergedFlyConfig){
//实例化父类
S.MyalibabaFavoritesGuess.superclass.constructor.call(this, data,oFlyConfig,oMergedFlyConfig);
this.result = data;
...
//继承父类
L.extend(S.MyalibabaFavoritesGuess,S.AbstractFlyView);
//接口实例化
L.augment(S.MyalibabaFavoritesGuess,S.InterfaceFlyView);
//方法封装
L.augmentObject(S.MyalibabaFavoritesGuess.prototype,{
onSuccess:function(){
FD.sys.fly.Utils.log('MyalibabaFavoritesGuess');
this._render();
var online = null;
new FD.widget.Alitalk(FYS( 'a[alitalk]', 'myalibaba-favorites-guess' ), {
onRemote: function() {
