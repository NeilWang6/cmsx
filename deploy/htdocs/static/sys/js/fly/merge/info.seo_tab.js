...
http://style.c.aliimg.com/js/sys/fly/widget/info.seo_tab.js
*/
...
onSuccess:function(){
FD.sys.fly.Utils.log('info-seo-tab');
this._render();
},
onFailure:function(){
this._render();
...
_renderOfferCount:function(){
var r = Math.round(Math.random()*100000);
if(r<10000){
r = r+10000;
}
if($("searchCount")){
$("searchCount").innerHTML = r;
}
},
_render:function(){
this._renderOfferCount();
var html = [];
...
var _title = '<p><a href="'+detailUrl+'"  onmousedown="FD.sys.fly.Utils.iClick({\'page\':'+this.oFlyConfig.coaseType+',\'objectId\':\''+offer.offerId+'\',\'recId\':\''+this.oFlyConfig.recid+'\',\'alg\':\''+offer.alg+'\',\'objectType\':\''+this.oFlyConfig.coaseOfferType+'\',\'pid\':\''+this.oFlyConfig.pid+'\'})"  target="_blank" class="red"><span>'+FD.sys.fly.Utils.doSubstring(offer.subject,16,true)+'</span></a></p>';
return _title;
},
