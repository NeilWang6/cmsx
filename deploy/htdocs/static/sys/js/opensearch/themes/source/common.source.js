/**
 * @package opensearch.theme.common
 * @import  opensearch
...
(function( win, S ){
    ...
    S.theme.common = {
        ...
        getHtmlRoot: function( result, customize, config ){
			...
			if (!S.mySidePoper) {
				S.mySidePoper = FD.widget.SidePoper.init('sidePop',null, {dockSide:0,expandDir:0,baseline:4,popregion:7,scroll:1,isFixed:0,bias:0,departure:0});
			} else {
				S.mySidePoper.config.popregion = FYG('openSearch').offsetHeight-FYG('sidePop').offsetHeight;
			}
        },
        /**
