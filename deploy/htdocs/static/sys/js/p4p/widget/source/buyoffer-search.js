...
(function(win,S){
	...
	S.P4POfferRecommendedRender=function(data,id,num){
		...
		this.searchtrace = 'buy_search_p4phot_offer';
		this.searchtrace_p4phere = 'buy_search_p4phere';
	    this.searchtrace_more = 'buy_search_p4phot_more';
		if(typeof window.iPageConfig=='object'&&window.iPageConfig.keywords==""){
			this.searchtrace = 'buy_list_p4phot_offer';
			this.searchtrace_more = 'buy_list_p4phot_more';
		}
