...
;(function($, D) {
	...
	$(function() {
		D.bottomAttr.bind = {
			...
			_ds_link : function() {
				$('#panel_tab').delegate('div.ds-link-attr select', 'change', function(e) {
			...
			_ds_image : function() {
				$('#panel_tab').delegate('div.ds-image-attr select', 'change', function(e) {
					var self = $(this), that = this, attrType = _findDataExtra(self);
					var extra = attrType.data(D.bottomAttr.CONSTANTS['extra']);
					var $html = extra.obj, val = that.options[that.selectedIndex].value;
					var dsoptions;
			...
			_ds_text : function() {
				$('#panel_tab').delegate('div.ds-text-attr select', 'change', function(e) {
					var self = $(this), that = this, attrType = _findDataExtra(self);
					var extra = attrType.data(D.bottomAttr.CONSTANTS['extra']);
					var $html = extra.obj, val = that.options[that.selectedIndex].value;
					var dsoptions;
				...
				$('#panel_tab').delegate('div.ds-text-attr input', 'input', function() {
					var self = $(this), that = this, attrType = _findDataExtra(self);
					var extra = attrType.data(D.bottomAttr.CONSTANTS['extra']);
			...
			_image : function() {
				...
				$('#panel_tab').delegate('div.image-attr input[name=alt]', 'input', function() {
				...
				$('#panel_tab').delegate('div.image-attr div.uploads', 'change', function(e) {
					var self = $(this), attrType = _findDataExtra(self);
					var extra = attrType.data(D.bottomAttr.CONSTANTS.extra);
			 ...
			 */
			_link : function() {
				$('#panel_tab').delegate('div.link-attr input[name=attr-link]', 'mouseup', function() {
				...
				$('#panel_tab').delegate('div.link-attr textarea[name=link-href]', 'input', function(e) {
					var self = $(this), attrType = _findDataExtra(self);
				 ...
				 * a标签title
				 */
				$('#panel_tab').delegate('div.link-attr input[name=link-title]', 'input', function() {
					var self = $(this), attrType = _findDataExtra(self);
					var extra = attrType.data(D.bottomAttr.CONSTANTS.extra), obj;
					if(extra) {
						obj = extra.obj;
			 ...
			 */
			_font_text : function() {
				$('#panel_tab').delegate('div.font-attr span.align-left', 'click', function() {
					var self = $(this), attrType = _findDataExtra(self);
					var extra = attrType.data(D.bottomAttr.CONSTANTS.extra);
					if(extra) {
				...
				$('#panel_tab').delegate('div.font-attr span.align-right', 'click', function() {
					var self = $(this), attrType = _findDataExtra(self);
					var extra = attrType.data(D.bottomAttr.CONSTANTS.extra);
					if(extra) {
						/**  D.EditContent.editCss({
				...
				$('#panel_tab').delegate('div.font-attr span.align-center', 'click', function() {
					var self = $(this), attrType = _findDataExtra(self);
					var extra = attrType.data(D.bottomAttr.CONSTANTS.extra);
					if(extra) {
						//  D.EditContent.editCss({
				...
				$('#panel_tab').delegate('div.font-attr span.font-bold', 'click', function() {
					var self = $(this), attrType = _findDataExtra(self);
					var extra = attrType.data(D.bottomAttr.CONSTANTS.extra);
					if(extra) {
				...
				$('#panel_tab').delegate('div.font-attr select.font-size', 'change', function() {
					var self = $(this), attrType = _findDataExtra(self);
					var extra = attrType.data(D.bottomAttr.CONSTANTS.extra);
					if(extra) {
						/**D.EditContent.editCss({
				...
				$('#panel_tab').delegate('div.font-attr select.font-family', 'change', function() {
					var self = $(this), attrType = _findDataExtra(self);
					var extra = attrType.data(D.bottomAttr.CONSTANTS.extra);
					if(extra) {
				...
				$('#panel_tab').delegate('div.font-attr input[name=hover-color]', 'input', function() {
					var self = $(this), attrType = _findDataExtra(self);
					var extra = attrType.data(D.bottomAttr.CONSTANTS.extra);
					if(extra) {
				...
				$('#panel_tab').delegate('div.font-attr #box-bottom-text', 'input', function() {
					var self = $(this), attrType = _findDataExtra(self);
					var extra = attrType.data(D.bottomAttr.CONSTANTS.extra);
					if(extra) {
						D.EditContent.editContent({
			...
			_background : function() {
				$('#panel_tab').delegate('div.background-attr .js-bg', 'click', function(event) {
				...
				$('#panel_tab').delegate('div.background-attr input[type=checkbox]', 'click', function() {
				...
				$('#panel_tab').delegate('div.background-attr input[name=color-box]', 'input', function() {
					var self = $(this), attrType = _findDataExtra(self);
					var extra = attrType.data(D.bottomAttr.CONSTANTS.extra);
					if(extra) {
						D.bottomAttr.colorBoxChange(self, self.val());
				...
				$('#panel_tab').delegate('div.background-attr a.box-img', 'click', function(e) {
				...
				$('#panel_tab').delegate('div.background-attr div.uploads', 'change', function(e) {
					var self = $(this), attrType = _findDataExtra(self);
					var extra = attrType.data(D.bottomAttr.CONSTANTS.extra);
					var url = $.trim(self.data('url'));
					var adboardId = $.trim(self.data('adboardid'));
			...
			_input : function() {
				...
				$('#panel_tab').delegate('div.height-width-attr input[type=text]', 'change', function() {
				...
				$('#panel_tab').delegate('div.height-width-attr input[type=text]', 'input', function() {
					var self = $(this), attrType = _findDataExtra(self), extra = attrType.data(D.bottomAttr.CONSTANTS.extra);
					if(extra) {
						if(extra.key !== D.bottomAttr.ATTRIBUTE.COPY) {
							_inputAttr(self, extra);
				...
				$('#panel_tab').delegate('.ds-box-repeat', 'click', function() {
					var self = $(this), attrType = _findDataExtra(self), extra = attrType.data(D.bottomAttr.CONSTANTS.extra);
					if(extra) {
			...
			_select : function() {
				$('#panel_tab').delegate('div.select-attr select[name=attr-select]', 'change', function() {
			...
			_ginput : function() {
				...
				$('#panel_tab').delegate('div.margin-attr input[type=text]', 'input', function() {
					var self = $(this), attrType = _findDataExtra(self), extra = attrType.data(D.bottomAttr.CONSTANTS.extra);
			...
			_public : function() {
				...
				$('#panel_tab').delegate('input[type=text]', 'focus', function() {
					var self = $(this);
					_showHighLight(self);
				});
				$('#panel_tab').delegate('input[type=checkbox]', 'mousedown', function() {
					var self = $(this);
					//console.log(self.attr('name'));
					_showHighLight(self);
				});
				$('#panel_tab').delegate('textarea', 'focus', function() {
					var self = $(this);
					_showHighLight(self);
				});
				//alert(1);
			...
			_color : function() {
				$('#panel_tab').delegate('div.hover-attr input[name=hover-color]', 'input', function() {
					var self = $(this), attrType = _findDataExtra(self);
					var extra = attrType.data(D.bottomAttr.CONSTANTS.extra);
					if(extra) {
						D.bottomAttr.colorBoxChange(self, self.val());
			 ...
			 */
			_border : function() {
				$('#panel_tab').delegate('div.border-attr input[type=checkbox]', 'change', function() {
				...
				$('#panel_tab').delegate('div.border-attr input[name=border-width]', 'input', function() {
				...
				$('#panel_tab').delegate('div.border-attr input[name=border-color]', 'input', function() {
					var self = $(this), attrType = _findDataExtra(self);
					var extra = attrType.data(D.bottomAttr.CONSTANTS.extra);
					if(extra) {
						D.bottomAttr.colorBoxChange(self, self.val());
				...
				$('#panel_tab').delegate('div.border-attr input[name=border-radius]', 'input', function() {
