...
(function ($, D) {
   ...
   $('#disable-btn').click(function(e){
                e.preventDefault();
                var templateParamId = $(this).data('tpid');
                if(window.confirm("确实要禁用该模板参数吗？")){
                    window.location.href = D.domain + '/page/edit_template_param.html?action=TemplateParamManagerAction&event_submit_do_disable_param=true&templatePramId=' + templateParamId;
                }
    });
 ...
 $('#active-btn').click(function(e){
                e.preventDefault();
                var templateParamId = $(this).data('tpid');
                if(window.confirm("确实要激活该模板参数吗？")){
                    window.location.href = D.domain + '/page/edit_template_param.html?action=TemplateParamManagerAction&event_submit_do_active_param=true&templatePramId=' + templateParamId;
                }
    });
