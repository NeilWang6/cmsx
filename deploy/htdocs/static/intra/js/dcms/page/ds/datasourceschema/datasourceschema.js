...
function addDsSchemaDetailTableRow() {
	...
	var autoTableRowData = new Array(
			...
			'<input name="mappingField" type="text" id="mappingField" size="10" dataType="LimitB" min="0" max="100" msg="此项最多不超过100字节"/>',
			...
			'<select name="primaryKeyFlag" id="primaryKeyFlag"><option value="0" selected>0-否</option><option value="1" >1-是</option></select>',
			'<select name="dataModifyFlag" id="dataModifyFlag"><option value="0" selected>0-否</option><option value="1" >1-是</option></select>',
