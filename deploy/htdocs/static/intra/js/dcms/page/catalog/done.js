...
;(function($, D, undefined){
    ...
    formInputs = $('input, textarea', editDialogEl),
                ...
                if (action==='add'){
                    ...
                    $.use('ui-dialog', function(){
                        confirmDialog = confirmDialogEl.dialog({
                            center: true,
                            open: function(){
                                var strTemp = '<li><span class="lab">原名称：</span><span class="txt">{catalogName}</span></li>'+
                                              '<li><span class="lab">原上级类目：</span><span class="txt">{parentId}</span></li>',
                                oldHtml = $.util.substitute(strTemp, oldData),
                                newHtml = $.util.substitute(strTemp, newData);
        ...
        $.use('ui-dialog', function(){
            editDialog = editDialogEl.dialog({
                ...
                open : function(){
                    ...
                    formInputs.eq(2).val(data.remarks);
    ...
    function getFomeValue(container){
        var formInputs = $('input, textarea', container),
        values = {};
