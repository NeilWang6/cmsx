...
_isLog && $.log( $.now() + ': the module ' + module.id + ' failed to register.' );
}
};
/**
* module exports
...
_isLog && $.log( $.now() + ': the module ' + module.id + ' failed to require.' );
}
};
pitaya.define = define;
pitaya.register = register;
