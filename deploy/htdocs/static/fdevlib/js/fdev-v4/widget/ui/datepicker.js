 ...
 * @update 2012.06.13 提供zIndex配置
 * @update 2013.03.21 fix当页面指定base target时点击空日期打开新页面问题 --- bruce.liz
 * @update 2013.06.17 terence.wangt 使用widgetBaseClass替代硬编码的ui-datepicker，使得组件支持对样式的扩展。
 * @update 2013.11.19 jianping.shenjp 增加resetDate方法
...
(function($, undefined) {
    ...
    $.widget('ui.datepicker', {
        ...
        render: function() {
            ...
            self.con.addClass( self.widgetBaseClass + ' fd-clr ' + self.widgetBaseClass + '-multi' + o.pages).empty();
        ...
        _buildEvent: function() {
            ...
            //点击触点
            self.activator.bind(o.triggerType + '.' + self.widgetBaseClass, function(e) {
                e.preventDefault();
                if (e.type === 'focus') {
                    self.show(e);
                } else {
        ...
        show: function(e) {
            ...
            self.con.css({
                ...
                if (o.popup) {
                    //noformat
                    $(document)
    				.unbind('click.' + self.widgetBaseClass)
    				.bind('click.' + self.widgetBaseClass, function(e){
    				...
    				//format 
                    self.con.bind('click.'+ self.widgetBaseClass, function(e) {
                        e.stopPropagation();
                    });
                }
        ...
        hide: function(e) {
            ...
            var o = self.options;
            if (o.popup) {
                $(document).unbind('click.' + self.widgetBaseClass);
            }
            function handler() {
                self.con.remove();
                $.extend(self, {
    ...
    $.extend($.ui.datepicker, {
        Page: function(config, father) {
            ...
            this.nav_html = '<p>月<select value="{the_month}"><option class="m1" value="1">01</option><option class="m2" value="2">02</option><option class="m3" value="3">03</option><option class="m4" value="4">04</option><option class="m5" value="5">05</option><option class="m6" value="6">06</option><option class="m7" value="7">07</option><option class="m8" value="8">08</option><option class="m9" value="9">09</option><option class="m10" value="10">10</option><option class="m11" value="11">11</option><option class="m12" value="12">12</option></select></p><p>年<input class="fui-text fui-text-s" type="text" value="{the_year}" onfocus="this.select()"/></p><p><button class="ok">确定</button><button class="cancel">取消</button></p>';
        }
    });
    $.extend($.ui.datepicker.Page.prototype, {
        ...
        _buildEvent: function() {
            ...
            $('div,a,input', con).unbind('.' + father.widgetBaseClass);
			//fix当页面指定base target时点击空日期打开新页面问题,add by bruce.liz
			$('a.null,a.disabled',con).bind('click.' + father.widgetBaseClass,function(e){
			   e.preventDefault();
			});			
            $('div.dbd', con).bind('mousedown.' + father.widgetBaseClass, function(e) {
                //e.preventDefault();
            ...
            //向前
            $('a.prev', con).bind('click.' + father.widgetBaseClass, function(e) {
                e.preventDefault();
            ...
            //向后
            $('a.next', con).bind('click.' + father.widgetBaseClass, function(e) {
                e.preventDefault();
            ...
            if (o.navigator) {
                $('a.title', con).bind('click.' + father.widgetBaseClass, function(e) {
					e.preventDefault();
                    try {
                    ...
                    $('input', con).bind('keydown.' + father.widgetBaseClass, function(e) {
                        var target = $(e.target);
                ...
                $('div.setime', con).bind('click.' + father.widgetBaseClass, function(e) {
                    e.preventDefault();
                    var target = $(e.target);
