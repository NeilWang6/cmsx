    ...
    var $util = $.util, chart = function(){
        ...
        if ($util.flash.hasVersion(10)) {
            var self = this, swfid = self.element[0].id, o = self.options, 
                //图表类型line:折线图 bar:柱状图 hbar:水平柱状图 pie:饼图 timeline:时间线
                swfurl = o.swf || $util.substitute('http://view.1688.com/book/swfapp/chart/beechart-{0}.swf', [o.type]);
