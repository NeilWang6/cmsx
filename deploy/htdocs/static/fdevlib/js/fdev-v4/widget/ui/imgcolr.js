// >>========= imgcolr plugin start, should not modify it =============
/*!
 * imgcolr v1.0.0
 * Author: Sway Deng
 * Released under the MIT license
 * https://github.com/swaydeng/imgcolr
 */
...
// <<========= imgcolr plugin finished =============

// ========= customize for fdev4 ======
(function ($) {
  var i = Imgcolr;
  if (i && !i.getSwf()) {
    i.setSwf('http://view.1688.com/book/swfapp/imgcolr/imgcolr.swf');
  }
