 ...
 * @update Desni 2011.12.05 增加反馈信息，去掉prop配置项
 */
;
window.online = null;
(function(w){
 ...
 defaults = {
        ...
        //弹出阿里旺旺下载页
        getAlitalk: function(){
            window.open('http://webww.1688.com/message/my_chat.htm', '_blank');
        }
    }, //回调函数
        ...
        switch (version) {
            ...
            case 6:
                if (o.online == 4) {
                    ...
                    invokeWW('aliim:sendmsg?touid=' + o.siteID + o.id + '&siteid=' + o.siteID + '&status=' + o.online + feedback + prop);
                }
                break;
        }
        if (o.onClickEnd) 
