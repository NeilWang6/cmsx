...
*		
*       在页面最底部
*       <script>new FD.widget.HubbleMonitor(window.g_config)</script>
*
...
(function(w){
	...
	var HubbleMonitor=function(el,opt){
		this.init.apply(this,arguments);
	};
	
	HubbleMonitor.prototype={
		init:function(cfg){
			var config = cfg || {},
