...
(function($) {
    ...
    $.fn.innerWidth = function() {
        return $(this).width() + curCSS(this[0], 'paddingLeft') + curCSS(this[0], 'paddingRight');
    }

    $.fn.innerHeight = function() {
        return $(this).height() + curCSS(this[0], 'paddingTop') + curCSS(this[0], 'paddingBottom');
    }

    $.fn.outerWidth = function(needMargin) {
        return needMargin === true ? 
                $(this).innerWidth() + curCSS(this[0], 'borderLeftWidth') + curCSS(this[0], 'borderRightWidth')
                    + curCSS(this[0], 'marginLeft') + curCSS(this[0], 'marginRight')
                : $(this).innerWidth() + curCSS(this[0], 'borderLeftWidth') + curCSS(this[0], 'borderRightWidth');
    }

    $.fn.outerHeight = function(needMargin) {
        return needMargin === true ? 
                $(this).innerHeight() + curCSS(this[0], 'borderTopWidth') + curCSS(this[0], 'borderBottomWidth')
                    + curCSS(this[0], 'marginTop') + curCSS(this[0], 'marginBottom')
                : $(this).innerHeight() + curCSS(this[0], 'borderTopWidth') + curCSS(this[0], 'borderBottomWidth');
    }
})(af);
