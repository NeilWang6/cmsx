 ...
 * @since 2014-02-07
 */
public class CmsxCasePropvalQuery implements Serializable {

    private static final long serialVersionUID = 139174911883870730L;
    ...
    public CmsxCasePropvalQuery() {
        super();
    }

    public CmsxCasePropvalQuery(Long id, Date gmtCreate, Date gmtModified, String createUser, String modifyUser, Long caseId, Long propId, String propVal, String propValueType) {
        this.id = id;
