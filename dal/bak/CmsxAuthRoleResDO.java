 ...
 * @since 2014-02-07
 */
public class CmsxAuthRoleResDO implements Serializable {

    private static final long serialVersionUID = 139174911273412457L;
    ...
    public CmsxAuthRoleResDO() {
        super();
    }

    public CmsxAuthRoleResDO(Long id, Date gmtCreate, Date gmtModified, String createUser, String modifyUser, Long roleid, Long resid) {
        this.id = id;
