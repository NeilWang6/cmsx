 ...
 * @since 2014-02-07
 */
public class CmsxAdminQuery implements Serializable {

    private static final long serialVersionUID = 139174909919867979L;
    ...
    public CmsxAdminQuery() {
        super();
    }

    public CmsxAdminQuery(Long id, String userid, String password, String realname, Short status, Date gmtCreate, Date gmtModified, String createUser, String modifyUser) {
        this.id = id;
        this.userid = userid;
