 ...
 * @since 2014-02-07
 */
public class CmsxAdminRoleQuery implements Serializable {

    private static final long serialVersionUID = 139174910339198032L;
    ...
    public CmsxAdminRoleQuery() {
        super();
    }

    public CmsxAdminRoleQuery(Long id, Long adminid, Long roleid, Date gmtCreate, Date gmtModified, String createUser, String modifyUser) {
        this.id = id;
