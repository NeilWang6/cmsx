 ...
 * @since 2014-02-07
 */
public class CmsxAuthRoleDO implements Serializable {

    private static final long serialVersionUID = 139174911099597038L;
    ...
    public CmsxAuthRoleDO() {
        super();
    }

    public CmsxAuthRoleDO(Long id, Date gmtCreate, Date gmtModified, String createUser, String modifyUser, String rolename, String memo) {
        this.id = id;
