 ...
 * @since 2014-02-07
 */
public class CmsxCaseCatalogPropDO implements Serializable {

    private static final long serialVersionUID = 139174911718304602L;
    ...
    public CmsxCaseCatalogPropDO() {
        super();
    }

    public CmsxCaseCatalogPropDO(Long id, Date gmtCreate, Date gmtModified, String createUser, String modifyUser, Long catalogid, Long propId, String propAlias, Short isKeyprop, String custValidRegex, Integer ordernum) {
        this.id = id;
