 ...
 * @since 2014-02-07
 */
public class CmsxMetaPropDO implements Serializable {

    private static final long serialVersionUID = 139174912198707028L;
    ...
    public CmsxMetaPropDO() {
        super();
    }

    public CmsxMetaPropDO(Long id, Date gmtCreate, Date gmtModified, String createUser, String modifyUser, String propCode, String propName, String propAliasName, String propViewType, String propViewAttr, String propValidRegex, String ctrlPath, String memo) {
        this.id = id;
