 ...
 * @since 2014-02-07
 */
public class CmsxMetaPropenumQuery implements Serializable {

    private static final long serialVersionUID = 139174912383944765L;
    ...
    public CmsxMetaPropenumQuery() {
        super();
    }

    public CmsxMetaPropenumQuery(Long id, Date gmtCreate, Date gmtModified, String createUser, String modifyUser, Long catalogid, Long propid, String propval, String propvalname, Long ordernum) {
        this.id = id;
