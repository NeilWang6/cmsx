 ...
 * @since 2014-02-07
 */
public class CmsxContentQuery implements Serializable {

    private static final long serialVersionUID = 139174912046168787L;
    ...
    public CmsxContentQuery() {
        super();
    }

    public CmsxContentQuery(Long id, Date gmtCreate, Date gmtModified, String createUser, String modifyUser, String content, String status) {
        this.id = id;
