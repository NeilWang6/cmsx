 ...
 * @since 2014-02-07
 */
public class CmsxCaseDO implements Serializable {

    private static final long serialVersionUID = 139174911431806871L;
    ...
    public CmsxCaseDO(Long id, Date gmtCreate, Date gmtModified, String createUser, String modifyUser, String projNum, String projName, String projBuildType, Long firestCatalogId, Long secondCatalogId, Short isStage, Integer stage, String projStatus, String projPlace, String way, BigDecimal totalInvest, String status) {
        this.id = id;
