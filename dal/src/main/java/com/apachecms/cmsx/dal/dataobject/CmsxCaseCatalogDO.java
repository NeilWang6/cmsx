 ...
 * @since 2014-02-07
 */
public class CmsxCaseCatalogDO implements Serializable {

    private static final long serialVersionUID = 139174911580374979L;
    ...
    public CmsxCaseCatalogDO() {
        super();
    }

    public CmsxCaseCatalogDO(Long id, Long parentId, String name, Date gmtCreate, Date gmtModified, String createUser, String modifyUser) {
        this.id = id;
